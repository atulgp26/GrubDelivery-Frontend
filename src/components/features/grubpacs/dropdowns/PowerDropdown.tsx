...
export default function PowerDropdown({ onConfirm, onCancel }: PowerDropdownProps) {
  ...
  return (
    <div className="bg-white border border-[var(--gp-color-stroke-neutral-secondary)] rounded-lg shadow-[0px_0px_4px_0px_rgba(0,0,0,0.1),4px_4px_8px_0px_rgba(0,0,0,0.12)] w-[260px] overflow-hidden">
      {/* Header */}
