    ...
    <header className="flex h-[var(--gp-topnav-height)] items-center justify-between bg-[var(--gp-color-bg-white)] border-b border-[var(--gp-color-border-neutral)] px-[var(--gp-padding-xl)] py-[var(--gp-padding-m)]">
      ...
      <div className="flex items-center relative">
        <Button
          ...
          appearance="outlined"
          size="sm"
          className={`flex items-center justify-center h-10 w-10 rounded-[var(--gp-radius-md)] !hover:bg-transparent !active:bg-transparent border transition-all ${isNotificationPage || showDropdown
            ...
            <div className="flex-1 flex flex-col overflow-y-auto overflow-x-hidden min-h-0 overscroll-contain">
              {isLoading
                ...
                : notifications.length === 0 ? (
                  <div className="flex-1 flex items-center justify-center p-6 text-[var(--gp-color-text-neutral-secondary)] text-sm">
                    No notification
                  </div>
                )
